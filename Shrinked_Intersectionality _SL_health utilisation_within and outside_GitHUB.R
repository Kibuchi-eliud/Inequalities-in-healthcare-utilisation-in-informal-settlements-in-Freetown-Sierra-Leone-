...
crosstable::crosstable(data_cleaned, barrier_qualitycare, by = health_utilization_in_out, total ="all")
...
crosstable::crosstable(data_cleaned, head_gender, by = health_utilization_in_out, total ="all")
...
HU_within_outside_model_1<- brm(health_utilization_in_out  ~ 1  + (1|strata_id), 
...
HU_within_outside_model1_fixed <- as.data.frame(fixef(HU_within_outside_model_1))
HU_within_outside_model1_fixed 

HU_within_outside_model1_fixed_effects <- as.data.frame(fixef(HU_within_outside_model_1))
HU_within_outside_model1_fixed_effects$Effect_Type <- "Fixed"
HU_within_outside_model1_fixed_effects$Group <- NA
HU_within_outside_model1_fixed_effects$Level <- NA
HU_within_outside_model1_fixed_effects$Parameter <- rownames(HU_within_outside_model1_fixed_effects)


# Extract group-level SD with 95% credible interval
HU_within_outside_model1_sd_summary <- as.data.frame(VarCorr(HU_within_outside_model_1)$strata_id$sd)
HU_within_outside_model1_sd_intercept_row <- HU_within_outside_model1_sd_summary[1, ]  # Assuming first row is for Intercept

HU_within_outside_model1_sd_df <- data.frame(
  Estimate = HU_within_outside_model1_sd_intercept_row$Estimate,
  Q2.5 = HU_within_outside_model1_sd_intercept_row$Q2.5,
  Q97.5 = HU_within_outside_model1_sd_intercept_row$Q97.5,
  Effect_Type = "Group_SD",
  Group = "strata_id",
  Level = NA,
  Parameter = "sd_strata_id__Intercept"
)
HU_within_outside_model1_sd_df

# Combine with fixed effects
HU_within_outside_model1_combined_effects <- bind_rows(HU_within_outside_model1_fixed_effects, HU_within_outside_model1_sd_df)


#Extract diagnostics 
HU_within_outside_model1_draws <- as_draws_df(HU_within_outside_model_1)
HU_within_outside_model1_diagnostics <- summarise_draws(HU_within_outside_model1_draws, "rhat", "ess_bulk", "ess_tail")
HU_within_outside_model1_diagnostics


# Filter diagnostics for relevant parameters
HU_within_outside_model1_diagnostics_filtered <- HU_within_outside_model1_diagnostics %>%
  filter(variable %in% HU_within_outside_model1_combined_effects$Parameter) %>%
  rename(Parameter = variable)
HU_within_outside_model1_diagnostics_filtered

# Merge effects with diagnostics
HU_within_outside_model1_final_combined <- left_join(HU_within_outside_model1_combined_effects, HU_within_outside_model1_diagnostics_filtered, by = "Parameter")
HU_within_outside_model1_final_combined

write.csv(HU_within_outside_model1_final_combined, "results/Review/within_outside/shrinked_HU_within_outside_model_1.csv")

HU_within_outside_model_1_exp <- exp(fixef(HU_within_outside_model_1)); HU_within_outside_model_1_exp
write.csv(HU_within_outside_model_1_exp, "results/Review/within_outside/shrinked_HU_within_outside_model_1_exponentiated.csv")
...
variance_group <-       0.650^2; variance_group 
VPC_model1 <-       0.650^2 / (0.650^2 +3.29)*100; VPC_model1

#model1_vpc = 11.38% - indicates high discriminatory accuracy of intersection strata 
...
HU_within_outside_model1 <- merge(data_cleaned_model1, r_Intercept2, by = "strata_id") 

#Export data
write.csv(HU_within_outside_model1, file = "results/Review/within_outside/HU_within_outside_model_1_household_data(161022025).csv")
...
#===========================================
HU_within_outside_model_2 <- brm(health_utilization_in_out ~ 1 + head_gender + marital_status +
...
print(summary(HU_within_outside_model_2), digits = 3)

# Extract fixed effects
HU_within_outside_model2_fixed_effects <- as.data.frame(fixef(HU_within_outside_model_2)) %>%
  mutate(
    Effect_Type = "Fixed",
    Group = NA,
    Level = NA,
...
HU_within_outside_model2_sd_summary <- as.data.frame(VarCorr(HU_within_outside_model_2)$strata_id$sd)
HU_within_outside_model2_sd_df <- HU_within_outside_model2_sd_summary %>%
  slice(1) %>%
  transmute(
    Estimate = Estimate,
    Q2.5 = Q2.5,
...
HU_within_outside_model2_effects_combined <- bind_rows(HU_within_outside_model2_fixed_effects, HU_within_outside_model2_sd_df)

# Extract model draws and diagnostics
HU_within_outside_model2_draws <- as_draws_df(HU_within_outside_model_2)
HU_within_outside_model2_diagnostics <- summarise_draws(HU_within_outside_model2_draws, "rhat", "ess_bulk", "ess_tail")

# Clean parameter names for matching (remove "b_" prefix from diagnostics)
HU_within_outside_model2_diagnostics_filtered <- HU_within_outside_model2_diagnostics %>%
  mutate(Parameter = str_remove(variable, "^b_"))

# Merge effects with diagnostics
HU_within_outside_model2_final_combined <- left_join(
  HU_within_outside_model2_effects_combined,
  HU_within_outside_model2_diagnostics_filtered,
  by = "Parameter"
)

# View final combined table
HU_within_outside_model2_final_combined
write.csv(HU_within_outside_model2_final_combined, "results/Review/within_outside/shrinked_HU_within_outside_model_2.csv")

HU_within_outside_model_2_exp <- exp(fixef(HU_within_outside_model_2)); HU_within_outside_model_2_exp 
write.csv(HU_within_outside_model_2_exp, "results/Review/within_outside/shrinked_HU_within_outside_model_2_exponentiated.csv")

#===============
#Classification rate
model2_Prob <- predict(HU_within_outside_model_2, type="response")
...
model2_variance <-  0.367^2; model2_variance 
model2_vpc <-    0.367^2 / (0.367^2 +3.29)*100; model2_vpc
#3.47%

#PCV
model1_variance <-  0.650^2
model2_variance <-  0.367^2
model2_PCV <- (0.650^2 - 0.367^2)/ 0.650^2 ; model2_PCV
model2_PCV <- model2_PCV*100; model2_PCV
#PCV=68.12%
#This indicates 31.88% of variance was not explained by adding fixed effects 
#=================================================================================================
#Plot
data2_RandomEffect <- ranef(HU_within_outside_model_2)
...
HU_within_outside_model2 <- merge(data_cleaned_model2, r_Intercept2, by = "strata_id") 

#Export data
write.csv(HU_within_outside_model2, file = "results/Review/within_outside/HU_within_outside_model2_household_(161025).csv")
...
HU_within_outside_model_3 <- brm(health_utilization_in_out ~ 1 + household_number + head_gender + 
...
print(summary(HU_within_outside_model_3), digits = 3)

# Extract fixed effects
HU_within_outside_model3_fixed_effects <- as.data.frame(fixef(HU_within_outside_model_3)) %>%
  mutate(
    Effect_Type = "Fixed",
    Group = NA,
    Level = NA,
...
# Extract group-level SD (assuming strata_id random intercept)
HU_within_outside_model3_sd_summary <- as.data.frame(VarCorr(HU_within_outside_model_3)$strata_id$sd)
HU_within_outside_model3_sd_df <- HU_within_outside_model3_sd_summary %>%
  slice(1) %>%
  transmute(
    Estimate = Estimate,
    Q2.5 = Q2.5,
...
# Combine fixed effects and SDs
HU_within_outside_model3_effects_combined <- bind_rows(HU_within_outside_model3_fixed_effects, HU_within_outside_model3_sd_df)

# Extract model draws and diagnostics
HU_within_outside_model3_draws <- as_draws_df(HU_within_outside_model_3)
HU_within_outside_model3_diagnostics <- summarise_draws(HU_within_outside_model3_draws, "rhat", "ess_bulk", "ess_tail")

# Clean parameter names for matching (remove "b_" prefix from diagnostics)
HU_within_outside_model3_diagnostics_filtered <- HU_within_outside_model3_diagnostics %>%
  mutate(Parameter = str_remove(variable, "^b_"))

# Merge effects with diagnostics
HU_within_outside_model3_final_combined <- left_join(
  HU_within_outside_model3_effects_combined,
  HU_within_outside_model3_diagnostics_filtered,
  by = "Parameter"
)

# View final combined table
HU_within_outside_model3_final_combined
write.csv(HU_within_outside_model3_final_combined, "results/Review/within_outside/shrinked_HU_within_outside_model_3.csv")

HU_within_outside_model_3_exp <- exp(fixef(HU_within_outside_model_3)); HU_within_outside_model_3_exp 
write.csv(HU_within_outside_model_3_exp, "results/Review/within_outside/shrinked_HU_within_outside_model_3_exponentiated.csv")
#==========================================

#Classification rate

model3_Prob <- predict(HU_within_outside_model_3, type="response")
...
model3_variance <-   0.276^2; model3_variance 
model3_vpc <-     0.276^2 / (0.276^2 +3.29)*100; model3_vpc

# 2.263%

#PCV
model1_variance <- 0.650^2
model3_variance <-   0.276^2
model3_PCV <- (0.650^2 - 0.276^2)/ 0.650^2 ; model3_PCV
model3_PCV <- model3_PCV*100; model3_PCV
#PCV=81.97%
#This indicates 18.03% of variance was not explained by adding strata and covariates variables
#=================================================================================================
#Plot
data3_RandomEffect <- ranef(HU_within_outside_model_3)
...
HU_within_outside_model_model3 <- merge(data_cleaned_model3, r3_Intercept2, by = "strata_id") 

#Export data
write.csv(HU_within_outside_model_model3, file = "results/Review/within_outside/HU_within_outside_model3_household(161025).csv")

#===============================================================================
#Plots 
grid.arrange(plot1, plot2,plot3, nrow=3, ncol=1)

HU_within_outside_model_plot <- ggpubr::ggarrange(plot1, plot2,plot3, ncol = 1, nrow = 3)

ggsave('results/Review/within_outside/HU_within_outside_model_household_plot2.pdf',HU_within_outside_model_plot, width = 10,height = 10,dpi = 1200)
ggsave('results/Review/within_outside/HU_within_outside_model_household_plot.tiff',HU_within_outside_model_plot, width =10,height=10,dpi = 300)
ggsave('results/Review/within_outside/_reised_HU_within_outside_model_plot.jpeg',HU_within_outside_model_plot, width =10,height=10,dpi=300)
...
params <- variables(HU_within_outside_model_1)

# Filter for fixed effects and standard deviation terms
selected_params <- params[grepl("^b_|^sd_", params)]
selected_params

MCMCtrace(HU_within_outside_model_1, params = selected_params, ISB = TRUE, pdf = FALSE)

# path
save_path <- "/Data/results/Review/within_outside/"

# Create the folder if it doesn't exist
dir.create(save_path, recursive = TRUE, showWarnings = FALSE)

# Save the PDF
pdf(file = paste0(save_path, "HU_within_outside_model_1_trace_fixed_sd.pdf"), width = 10, height = 8)
MCMCtrace(HU_within_outside_model_1, params = selected_params, ISB = TRUE, pdf = FALSE)

#========================================================
#Model 2
# Get all parameter names
params <- variables(HU_within_outside_model_2)

# Filter for fixed effects and standard deviation terms
selected_params <- params[grepl("^b_|^sd_", params)]
selected_params

MCMCtrace(HU_within_outside_model_2, params = selected_params, ISB = TRUE, pdf = FALSE)

# Save the PDF
pdf(file = paste0(save_path, "HU_within_outside_model_2_trace_fixed_sd.pdf"), width = 10, height = 8)
MCMCtrace(HU_within_outside_model_2, params = selected_params, ISB = TRUE, pdf = FALSE)
dev.off()
#========================================================
#Model 3
# Get all parameter names
params <- variables(HU_within_outside_model_3)

# Filter for fixed effects and standard deviation terms
selected_params <- params[grepl("^b_|^sd_", params)]
selected_params

MCMCtrace(HU_within_outside_model_3, params = selected_params, ISB = TRUE, pdf = FALSE)

# Save the PDF
pdf(file = paste0(save_path, "HU_within_outside_model_3_trace_fixed_sd.pdf"), width = 10, height = 8)
MCMCtrace(HU_within_outside_model_3, params = selected_params, ISB = TRUE, pdf = FALSE)
dev.off()
